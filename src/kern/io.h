...
extern struct io_intf *__attribute__((nonnull(1, 2)))
...
extern char *__attribute__((nonnull(1, 2)))
 ...
 * Function: ioclose
 *
 * Description: Closes an io object when reference count reaches zero.
 *
 * Inputs:
 * io (struct io_intf *) - Pointer to io object
 *
 * Output: None
 *
 * Side Effects:
 * - Calls close operation on io object only if reference count reaches zero
 ******************************************************************************/
